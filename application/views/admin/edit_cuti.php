						...
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<?php echo form_open('admin/update_cuti/'.$cuti->id_ct, ['class' => 'form-horizontal', 'method' => 'post']); ?>
									<div class="form-group row">
										<label for="" class="col-sm-3 col-form-label">Kode Cuti</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" name="id_ct" value="<?php echo set_value('id_ct', $cuti->id_ct); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="nama_ct" value="<?php echo set_value('nama_ct', $cuti->nama_ct); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="divisi_ct" value="<?php echo set_value('divisi_ct', $cuti->divisi_ct); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tgl_ct" value="<?php echo set_value('tgl_ct', $cuti->tgl_ct); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="jenis_ct" value="<?php echo set_value('jenis_ct', $cuti->jenis_ct); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="alasan_ct" value="<?php echo set_value('alasan_ct', $cuti->alasan_ct); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="informasi_ct" class="form-control" value="<?php echo set_value('informasi_ct', $cuti->informasi_ct); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="pjs_ct" class="form-control" value="<?php echo set_value('pjs_ct', $cuti->pjs_ct); ?>">
