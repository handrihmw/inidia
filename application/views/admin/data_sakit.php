                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo base_url();?>admin/detail_sakit/<?php echo $skt->id_skt;?>" class="btn btn-xs btn-success m-r-5" role="button" title="Detail">
                                                        <i class="icon-magnifier"></i>&nbsp;
                                                        <a href="<?php echo base_url();?>admin/edit_sakit/<?php echo $skt->id_skt;?>" class="btn btn-xs btn-primary m-r-5" role="button" title="Edit">
                                                        <i class="icon-pencil"></i>
                                                        <a href="<?php echo base_url();?>admin/delete_sakit/<?php echo $skt->id_skt;?>"
