						...
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<?php echo form_open('admin/update_izin/'.$izin->id_izn, ['class' => 'form-horizontal', 'method' => 'post']); ?>
									<div class="form-group row">
										<label for="" class="col-sm-3 col-form-label">Kode Cuti</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" name="id_izn" value="<?php echo set_value('id_izn', $izin->id_izn); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="jenis_izn" value="<?php echo set_value('jenis_izn', $izin->jenis_izn); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tgl_minta_izn" value="<?php echo set_value('tgl_minta_izn', $izin->tgl_minta_izn); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tgl_akhir_izn" value="<?php echo set_value('tgl_akhir_izn', $izin->tgl_akhir_izn); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="nama_izn" value="<?php echo set_value('nama_izn', $izin->nama_izn); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="alasan_izn" value="<?php echo set_value('alasan_izn', $izin->alasan_izn); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="pjs_izn" class="form-control" value="<?php echo set_value('pjs_izn', $izin->pjs_izn); ?>">
