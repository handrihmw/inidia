					...
					<div class="row clearfix">
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									<?php echo form_open('admin/save_pangkat', ['class' => 'form-horizontal', 'method' => 'post']); ?>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" name="pangkat"  value="<?php echo set_value('pangkat'); ?>">
