					...
					<div class="row clearfix">
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									<?php echo form_open('admin/update_pangkat/'.$pgk_ ->id, ['class' => 'form-horizontal', 'method' => 'post']); ?>
									<div class="form-group row">
										<label for="" class="col-sm-3 col-form-label">Kode Pangkat</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" name="id" readonly value="<?php echo set_value('id', $pgk_->id); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="pangkat" value="<?php echo set_value('pangkat', $pgk_->pangkat); ?>">
									...
									<div class="form-group row">
										<div class="col-sm-6">
											...
											<a href="<?php echo site_url();?>admin/pangkat" class="btn btn-xs btn-danger" role="button">
