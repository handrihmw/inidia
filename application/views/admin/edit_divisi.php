					...
					<div class="row clearfix">
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									<?php echo form_open('admin/update_divisi/'.$dvs_->id, ['class' => 'form-horizontal', 'method' => 'post']); ?>
									<div class="form-group row">
									<label for="" class="col-sm-3 col-form-label">Kode divisi</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" name="id" readonly value="<?php echo set_value('id', $dvs_->id); ?>">
											<?php echo form_error('id'); ?>
										</div>
									</div>
									<div class="form-group row">
										<label for="" class="col-sm-3 col-form-label">Unik</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" name="unik" value="<?php echo set_value('unik', $dvs_->unik); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="divisi" value="<?php echo set_value('divisi', $dvs_->divisi); ?>">
