						...
						<div class="col-lg-12">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <a href="<?php echo base_url();?>admin/add_pangkat" class="btn btn-xs btn-default" role="button" title="Tambah">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" width="100%" cellpadding="0" cellspacing="0" id="examples">
                                        ...
                                        <tbody>
                                        <?php foreach ($pangkat as $pgk_): ?>
                                            <tr>
                                                <td style="text-align: center;"><?= $pgk_->id ?></td>
                                                <td><?= $pgk_->pangkat ?></td>
                                                <td style="text-align: center;">
                                                    <a href="<?php echo base_url();?>admin/edit_pangkat/<?php echo $pgk_->id;?>" class="btn btn-xs btn-primary m-r-5" role="button" title="ubah">
                                                    <i class="icon-pencil"></i>&nbsp;
                                                    <a href="<?php echo base_url();?>admin/delete_pangkat/<?php echo $pgk_->id;?>"
