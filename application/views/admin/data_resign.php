						...
						<div class="col-lg-12">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <a href="<?php echo base_url();?>admin/add_resign" class="btn btn-xs btn-default" role="button" title="Tambah Karyawan">
                                    ...
                                    <a href="<?php echo base_url() ?>admin/print_resign" class="btn btn-xs btn-default" role="button" title="Print Data" target="_blank">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <a href="<?php echo base_url();?>admin/edit_resign/<?php echo $kry->id_rs;?>" class="btn btn-xs btn-primary m-r-5" role="button" title="Edit">
                                                        <i class="icon-pencil"></i>&nbsp;
                                                        <a href="<?php echo base_url();?>admin/delete_resign/<?php echo $kry->id_rs;?>" onclick="return confirm('Apakah Anda Yakin?');" 
