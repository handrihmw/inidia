					...
					<div class="row clearfix">
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									<?php echo form_open('admin/save_dinas', ['class' => 'form-horizontal', 'method' => 'post']); ?>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="nama_dns"  value="<?php echo set_value('nama_dns'); ?>">
		...
		<script type="text/javascript">
			$(document).ready(function () {
				...
				$('#kode').on('input',function(){
					...
					$.ajax({
						type : "POST",
						url  : "<?php echo base_url('admin/get_dinas')?>",
						dataType : "JSON",
						data : {id_kry: id_kry},
						cache:false,
