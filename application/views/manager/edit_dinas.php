						...
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<?php echo form_open('manager/update_dinas/'.$dinas->id_dns, ['class' => 'form-horizontal', 'method' => 'post']); ?>
									<div class="form-group row">
										<label for="" class="col-sm-3 col-form-label">Kode Dinas</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" name="id_dns" readonly value="<?php echo set_value('id_dns', $dinas->id_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="jenis_dns" value="<?php echo set_value('jenis_dns', $dinas->jenis_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="kepentingan_dns" value="<?php echo set_value('kepentingan_dns', $dinas->kepentingan_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="nama_dns" readonly value="<?php echo set_value('nama_dns', $dinas->nama_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="total_dns" value="<?php echo set_value('total_dns', $dinas->total_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tgl_awal_dns" value="<?php echo set_value('tgl_awal_dns', $dinas->tgl_awal_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tgl_akhir_dns" value="<?php echo set_value('tgl_akhir_dns', $dinas->tgl_akhir_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="tujuan_dns" class="form-control" value="<?php echo set_value('tujuan_dns', $dinas->tujuan_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="pembayaran_dns" class="form-control" value="<?php echo set_value('pembayaran_dns', $dinas->pembayaran_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="tgl_bayar_dns" class="form-control" value="<?php echo set_value('tgl_bayar_dns', $dinas->tgl_bayar_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="keterangan_dns" class="form-control" value="<?php echo set_value('keterangan_dns', $dinas->keterangan_dns); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="pjs_dns" class="form-control" value="<?php echo set_value('pjs_dns', $dinas->pjs_dns); ?>" readonly>
									...
									<div class="form-group row">
										<div class="col-sm-6">
											...
											<a href="<?php echo site_url();?>manager/dinas" class="btn btn-xs btn-danger" role="button">
