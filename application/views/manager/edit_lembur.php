						...
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<?php echo form_open('manager/update_lembur/'.$lembur->id_ot, ['class' => 'form-horizontal', 'method' => 'post']); ?>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tanggal_ot" value="<?php echo set_value('tanggal_ot', $lembur->tanggal_ot); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="waktu_ot" value="<?php echo set_value('waktu_ot', $lembur->waktu_ot); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="nama_ot" value="<?php echo set_value('nama_ot', $lembur->nama_ot); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="keterangan_ot" value="<?php echo set_value('keterangan_ot', $lembur->keterangan_ot); ?>" readonly>
									...
									<div class="form-group row">
										<div class="col-sm-6">
											...
											<a href="<?php echo site_url();?>manager/lembur" class="btn btn-xs btn-danger" role="button">
