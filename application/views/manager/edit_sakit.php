						...
						<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<?php echo form_open('manager/update_sakit/'.$sakit->id_skt, ['class' => 'form-horizontal', 'method' => 'post']); ?>
									<div class="form-group row">
										<label for="" class="col-sm-3 col-form-label">Kode Sakit</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" name="id_skt" readonly value="<?php echo set_value('id_skt', $sakit->id_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="nama_skt" readonly value="<?php echo set_value('nama_skt', $sakit->nama_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="nik_skt" value="<?php echo set_value('nik_skt', $sakit->nik_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="jabatan_skt" value="<?php echo set_value('jabatan_skt', $sakit->jabatan_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tgl_awal_skt" value="<?php echo set_value('tgl_awal_skt', $sakit->tgl_awal_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="tgl_akhir_skt" value="<?php echo set_value('tgl_akhir_skt', $sakit->tgl_akhir_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="jml_skt" class="form-control" value="<?php echo set_value('jml_skt', $sakit->jml_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="penyakit_skt" class="form-control" value="<?php echo set_value('penyakit_skt', $sakit->penyakit_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="keterangan_skt" class="form-control" value="<?php echo set_value('keterangan_skt', $sakit->keterangan_skt); ?>" readonly>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="pjs_skt" class="form-control" value="<?php echo set_value('pjs_skt', $sakit->pjs_skt); ?>" readonly>
									...
									<div class="form-group row">
										<label for="" class="col-sm-3 col-form-label">Lampiran</label>
										<div class="col-sm-6">
											<input type="text" name="lampiran_skt" class="form-control" value="<?php echo set_value('lampiran_skt', $sakit->lampiran_skt); ?>" readonly>
