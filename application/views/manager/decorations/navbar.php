<nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="<?php echo base_url('manager/index');?>"><img src="<?php echo base_url() ?>assets/images/logo-dark.png" alt="Astrindo Logo" class="img-responsive logo"></a>                
            </div>
            
            <div class="navbar-right">
                <form id="navbar-search" class="navbar-form search-form">
                    <input value="" class="form-control" placeholder="" type="text">
