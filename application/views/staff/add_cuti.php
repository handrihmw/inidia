							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="namanya" name="nama_ct" value="<?= $this->session->userdata('name') ?>">
									...
									<div class="form-group row">
										<div class="col-sm-6">
											...
											<a href="<?php echo site_url();?>staff/cuti" class="btn btn-xs btn-danger" role="button">
		...
		<script type="text/javascript">
			$(document).ready(function () {
				...
				$('#kode').on('input',function(){
					...
					$.ajax({
						type : "POST",
						url  : "<?php echo base_url('staff/get_cuti')?>",
						dataType : "JSON",
						data : {id_kry: id_kry},
						cache:false,
						success: function(data){
